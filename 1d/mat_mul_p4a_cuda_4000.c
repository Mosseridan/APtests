...
void p4a_launcher_mat_mul(int *a, int *b, int *c)
{
   // Declared by Pass Outlining
   int i, j;
   P4A_call_accel_kernel_2d(p4a_wrapper_mat_mul, 4000, 4000, i, j, a, b, c);
}
void mat_mul(int *a, int *b, int *c)
{
   {
      //PIPS generated variable
      int (*p4a_var_c0)[16000000] = (int (*)[16000000]) 0, (*p4a_var_b0)[16000000] = (int (*)[16000000]) 0, (*p4a_var_a0)[16000000] = (int (*)[16000000]) 0;
      P4A_accel_malloc((void **) &p4a_var_a0, sizeof(int)*16000000);
      P4A_accel_malloc((void **) &p4a_var_b0, sizeof(int)*16000000);
      P4A_accel_malloc((void **) &p4a_var_c0, sizeof(int)*16000000);
      P4A_copy_to_accel_1d(sizeof(int), 16000000, 16000000, 0, &a[0], *p4a_var_a0);
      P4A_copy_to_accel_1d(sizeof(int), 16000000, 16000000, 0, &b[0], *p4a_var_b0);
      P4A_copy_to_accel_1d(sizeof(int), 16000000, 16000000, 0, &c[0], *p4a_var_c0);

      p4a_launcher_mat_mul(*p4a_var_a0, *p4a_var_b0, *p4a_var_c0);
      P4A_copy_from_accel_1d(sizeof(int), 16000000, 16000000, 0, &c[0], *p4a_var_c0);
