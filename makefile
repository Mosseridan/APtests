all: mat_mul mat_mul_function_calls mat_mul_function_calls2 mat_mul_function_calls3 mat_mul_function_calls4 mat_mul_loop_unroll mat_mul_loop_unroll2 mat_mul_loop_unroll3

mat_mul: mat_mul.c
	gcc -o mat_mul.out mat_mul.c
