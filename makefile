...
run_tests_dyn: run_tests_dyn.c mat_mul_dyn.c
	gcc -g -fopenmp -o run_tests_dyn.out run_tests_dyn.c mat_mul_dyn.c -I.

run_tests_dyn_p4a: run_tests_dyn.c mat_mul_dyn_p4a.c
	gcc -g -fopenmp -o run_tests_dyn_p4a.out run_tests_dyn.c mat_mul_dyn_p4a.c -I.

run_tests_dyn_rose: run_tests_dyn.c mat_mul_dyn_rose.c
	gcc -g -fopenmp -o run_tests_dyn_rose.out run_tests_dyn.c mat_mul_dyn_rose.c -I.

run_tests_dyn_cetus: run_tests_dyn.c mat_mul_dyn_cetus.c
	gcc -g -fopenmp -o run_tests_dyn_cetus.out run_tests_dyn.c mat_mul_dyn_cetus.c -I.
